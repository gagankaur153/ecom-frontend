          ...
          <table className="w-full m-12 border  border-blue-600 p-4">
            ...
            <tbody>
              {users.map((item) => (
                <tr
                  key={item?._id}
                  className="border-r border-b text-lg border-blue-600"
                >
                  <th className="border-r p-2 border-blue-600">
                    {item?.username}
                  </th>
                  <th className="border-r p-3 border-blue-600">
                    {item?.email}
                  </th>
                  <th className="border-r p-4 border-blue-600">
