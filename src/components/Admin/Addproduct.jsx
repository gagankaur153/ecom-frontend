...
const Addproduct = () => {
    ...
    const submit = (e)=>{
        e.preventDefault()
        setloading(true)
            addnewproduct(productdetail?.title, productdetail?.price, productdetail?.category, productdetail?.description,file,setproductdetail, setfile,fileInputRef, setLoading )
  ...
  return (
    <div className=' flex justify-center mt-28 max-w-8xl h-[90%] text-white '>
     ...
     <div className='flex flex-col space-y-2'>
       ...
       <div className='flex flex-col space-y-2'>
        ...
        <div className='p-8 flex justify-center '>
            <button className='py-2 px-6 rounded-2xl bg-purple-900 text-2xl font-semibold hover:bg-purple-950' onClick={(e)=>submit(e)}>{Loading ? "Loading..." : "Login"}</button>
        </div>
     </div>
