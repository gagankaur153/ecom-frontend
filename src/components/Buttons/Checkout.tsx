              ...
              <div className="col-span-8 border border-blue-600">
                ...
                <div>
                      ...
                      carts.item.map((product: any) => (
                        <div className="flex" key={product._id}>
                          ...
                          <div className="w-[20%] flex items-center justify-center md:p-3 text-3xl   text-center border-blue-600 border">
                            <p onClick={() => rremove(product?.productid?._id)}>
                              <MdDeleteOutline />
                            </p>
                          </div>
                        </div>
                  ...
                  <div className=" flex m-4 mt-0">
                    <div className="w-[25%] md:p-3 md:text-lg font-bold text-center border-blue-600 border"></div>
                    <div className="w-[30%] md:p-3 md:text-lg font-bold flex justify-center text-center border-blue-600 border">
                      <p className="bg-blue-600 md:py-1 w-1/2  rounded">
                        Total
                      </p>
                    </div>
                    <div className="w-[15%] md:p-3 md:text-lg font-bold flex justify-center text-center border-blue-600 border">
                      <p className="bg-yellow-600 md:py-1 px-1  rounded">
                        {carts?.totalamount}
                      </p>
                    </div>
                    <div className="w-[10%] md:p-3 md:text-lg font-bold flex justify-center  text-center border-blue-600 border">
                      <p className="bg-sky-500 md:py-1 px-2  rounded">
                        {carts?.totalquantity}
                      </p>
                    </div>
                    <div className="w-[10%] md:p-3 md:text-lg font-bold  text-center border-blue-600 border"></div>
                    <div className="w-[10%] md:p-3 md:text-lg font-bold  text-center border-blue-600 border"></div>
                    <div className="w-[20%] md:p-3 md:text-lg font-bold  text-center border-blue-600 border"></div>
                  </div>
                </div>
              </div>
